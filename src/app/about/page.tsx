        ...
        <main className="container mx-auto px-6 py-8">
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-700">
              I’m Abhishek Gupta, a skilled web and app developer with a passion for creating dynamic and responsive applications. With 8+ years of experience in various technologies, I am able provide solutions that meet modern standards and client needs.
            </p>
          </section>
          {/* Technical Skills */}
          <section className="mb-12">
